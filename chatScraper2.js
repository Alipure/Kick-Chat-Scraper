...
readline.question('Enter the Kick channel URL (e.g., https://kick.com/username or username): ', async (channelUrl) => {
    ...
    // Output file
    const chatFile = '/home/single/Documents/Bots/Kick-Chat-Scraper/chat2.txt';
    ...
    try {
        ...
        console.error('An error occurred, repeating the function:', error.message);
        scrollAndCollectMessages();
    }
});